...
@click.option(
    "--odoo-requirements-path",
    help="Odoo requirements.txt file path",
    default="/home/odoo/instance/odoo/requirements.txt",
    show_default=True,
)
@click.option(
    "--full-requirements-path",
    help="DeployV full_requirements.txt file path",
    default="/home/odoo/full_requirements.txt",
    show_default=True,
)
def clean_requirements(**kwargs):
    ...
    with open(odoo_requirements_path) as f_odoo_requirements, open(
        project_requirements_path
    ) as f_project_requirements, open(full_requirements_path) as f_full_requirements:
